...
function parseKickFrame(raw) {
  ...
  // For subscription/gift-shaped events we also dump the full payload so we can
  // see exactly which fields Kick sends (gifter, count, usernames).
  if (!eventName.startsWith("pusher:") && eventName !== "App\\Events\\ChatMessageEvent") {
